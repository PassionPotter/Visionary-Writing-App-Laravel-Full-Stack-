...
<div id="page-wrapper">
    ...
    <div class="container">
        <div class="row profile-dash-top">
            <div class="col-md-6 col-xs-4">
                ...
                @if(Auth::check())
                    <img src="{{asset('public/books/avatars')}}/{{$user_profile->avatar}}" class="profile-image" alt="Responsive Image">
    ...
    <div class="row user-details-card">
        ...
        <div class="panel panel-default last-block">
            <div class="panel-heading">
                <div>Wallet Balance</div>
                <div class="huge">{{ number_format($user_data[0]->amount, 2) }}</div>
            </div>
        </div>
    </div>

    <div class="clearfix user-edit-option">
        <div class="col-xs-4">
                <a href="{{route('books')}}" class="btn btn-primary btn-block small-dev "> Books</a>
        </div>
        <div class="col-xs-4">
                <a href="{{route('/payment/details')}}" class="btn btn-success btn-block small-dev "> Earnings</a>
        </div>
        <div class="col-xs-4">
                <a href="{{route('user.profile')}}" class="btn btn-warning btn-block small-dev ">Edit Profile</a>
        </div>
    </div>
    <div class="clearfix user-edit-option mobile-mt-10">
        <div class="col-xs-4">
                <a href="{{route('author/books/author_id',['author' =>Auth::user()->name, 'id' => Auth::user()->id])}}" 
                class="btn btn-info btn-block small-dev "> Profile</a>
        </div>
        <div class="col-xs-4">
                <a href="{{route('comments')}}" class="btn btn-default btn-block small-dev "> Comments</a>
        </div>
        <div class="col-xs-4">
                <a href="{{route('trashed.books')}}" class="btn btn-danger btn-block small-dev ">Trash</a>
        </div>
    </div>
    @if(!Auth::user()->admin)
