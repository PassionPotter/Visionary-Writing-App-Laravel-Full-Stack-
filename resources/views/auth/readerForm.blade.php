...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Become a Reader</div>

                <div class="card-body" >
                    <div style="text-align: center;">
                <img src="{{asset('books/avatars/avatar.png')}}" id="uId" style="cursor: pointer;margin: 0 auto;" title="click for image chang" class="img-responsive" /></div>
                    <form method="POST" action="{{ route('register-reader') }}">
                        @csrf
                         <input type="hidden" name="avatar" id="avatar" class="form-control" value="avatar.png">
                         <input type="hidden" name="reader" class="form-control" value="1">
