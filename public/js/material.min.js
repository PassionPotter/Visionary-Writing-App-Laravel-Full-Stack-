  ...
  function b(a) {
    return "undefined" == typeof a.which
      ...
      : "number" == typeof a.which && a.which > 0
        ? !a.ctrlKey && !a.metaKey && !a.altKey && 8 != a.which && 9 != a.which
        : !1;
  }
  function c(b) {
    a(b)
  ...
  (a.expr[":"].notmdproc = function(b) {
    ...
    (a.material = {
      ...
      attachInputEventHandlers: function() {
        a(".form-group .checkbox label").hover(
          function() {
            c(this);
          },
          function() {
          ...
          a(document)
            ...
            .on("keyup change", ".form-control", function() {
              ...
              "" === b.val() && d
                ...
                d ? c.removeClass("has-error") : c.addClass("has-error");
            })
        ...
        a.fn.ripples && this.options.ripples && this.ripples(),
          ...
          document.arrive &&
            ...
            (a.fn.ripples &&
              ...
              b.arrive(this.options.withRipples, function() {
                a.material.ripples(a(this));
              }),
            this.options.input &&
              b.arrive(this.options.inputElements, function() {
                a.material.input(a(this));
              }),
            this.options.checkbox &&
              b.arrive(this.options.checkboxElements, function() {
                a.material.checkbox(a(this));
              }),
            this.options.radio &&
              b.arrive(this.options.radioElements, function() {
                a.material.radio(a(this));
              }),
            this.options.togglebutton &&
              b.arrive(this.options.togglebuttonElements, function() {
