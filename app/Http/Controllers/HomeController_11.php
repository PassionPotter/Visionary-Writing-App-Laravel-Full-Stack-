...
//DB::enableQueryLog(); 
		...
		->leftJoin('Chapter', 'Chapter.book_id', '=', 'book.id')
		->having('total_chapter','>=','15')
  ...
  {   
      ...
      foreach ($all_books as $key => $value) {
         $value['view_count'] = $this->number_format_short(DB::table('books_view_count')->where('book_id',$value['book_id'])->count());
      }
